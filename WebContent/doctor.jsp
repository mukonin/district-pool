...
<div class="container col-sm-12">
	<div class="panel panel-default">
  		<div class="panel-heading">
			<h4>Doctor ${doctor.person.firstName} ${doctor.person.lastName} patients</h4>
		</div>
		<div class="panel-body">
							...
							<tr>
								...
								<td class="text-center col-md-1">
									<form action="/hospital/EditServlet" method="post">
										...
										<input type = "hidden" name = "id1" value = "${doctor.person.id}"/>
			...
			<form action="/hospital/EditServlet" method="post">
				<input type = "hidden" name = "id" value = "${doctor.person.id}"/>
