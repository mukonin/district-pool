					...
					<tr>
						...
						<td class="text-center col-md-1">
							<form action="/hospital/EditServlet" method="post">
								<button type="submit" value="delete" name="action" class="btn btn-md btn-danger" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure you want to delete Doctor ${user.firstName} ${user.lastName}');">
